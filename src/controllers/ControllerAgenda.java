...
//    }
    ...
    private void jbtn_nuevo_actionPerformed(){
        ...
        viewAgenda.jtf_telefono.setText(modelAgenda.getLimpiar_cajas()); //limia la caja telefono
    }
    /**
    ...
    */
    private void jbtn_guardar_actionPerformed(){
        ...
        modelAgenda.setTelefono(viewAgenda.jtf_telefono.getText()); // nuevo valor de telefono
    ...
    private void jbtn_Modificar_actionPerformed(){
        ...
        modelAgenda.setNombre(viewAgenda.jtf_nombre.getText()); //Nuevo valor de nombre
        modelAgenda.setEmail(viewAgenda.jtf_email.getText()); // nuevo valor de email
        modelAgenda.setTelefono(viewAgenda.jtf_telefono.getText()); // nuevo valor de email
